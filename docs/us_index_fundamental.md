# Source: https://www.lixinger.com/open/api/doc?api-key=us/index/fundamental

# 基本面数据API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22us%22,%22dataType%22:%22index%22}])
...
* `https://open.lixinger.com/api/us/index/fundamental`
