# Source: https://www.lixinger.com/open/api/doc?api-key=hk/company/hot/tr_dri

# 分红再投入收益率API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22hk%22,%22dataType%22:%22company%22}])
