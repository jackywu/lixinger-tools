# Source: https://www.lixinger.com/open/api/doc?api-key=cn/company/customers

# 客户API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22cn%22,%22dataType%22:%22company%22}])
