# Source: https://www.lixinger.com/open/api/doc?api-key=hk/company/operation-revenue-constitution

# 营收构成API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22hk%22,%22dataType%22:%22company%22}])
