# Source: https://www.lixinger.com/open/api/doc?api-key=cn/company/equity-change

# 股本变动API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22cn%22,%22dataType%22:%22company%22}])
