# Source: https://www.lixinger.com/open/api/doc?api-key=hk/company/hot/npd

# 派息API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22hk%22,%22dataType%22:%22company%22}])
...
* `https://open.lixinger.com/api/hk/company/hot/npd`
