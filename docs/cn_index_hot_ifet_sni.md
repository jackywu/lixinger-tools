# Source: https://www.lixinger.com/open/api/doc?api-key=cn/index/hot/ifet_sni

# 场内基金认购净流入API[购买](/open/api/price-tier?api-groups=[{%22areaCode%22:%22cn%22,%22dataType%22:%22index%22}])
...
* `https://open.lixinger.com/api/cn/index/hot/ifet_sni`
